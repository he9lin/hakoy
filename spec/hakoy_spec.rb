...
describe Hakoy do
  after do
    FileUtils.remove_dir(File.join(tmp_path, Hakoy.root_dir), true)
  end
  ...
  it 'stores csv rows in timestamp sliced directories' do
    ...
    file1 = File.join tmp_path, 'store_1', '2014/5/26.csv'
    file2 = File.join tmp_path, 'store_1', '2014/5/28.csv'
